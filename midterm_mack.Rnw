...
colstore <- c(rep("I", 5), rep("II", 5), rep("III", 5), 
              rep("IV", 5), rep("V", 5))
latin <- c("E", "D", "B", "C", "A", "C", "B", "E", "A", "D", "B", "A", "D", "E", "C","A", "E", "C", "D", "B")

greek <- c("alpha", "delta", "epsilon", "beta", "gamma", "delta", "beta", "gamma", "epsilon", "alpha", "gamma", "alpha", "beta", "delta", "epsilon", "epsilon", "gamma", "delta", "alpha", "beta", "beta", "epsilon", "alpha", "gamma", "delta")

dollars <- c(238,149,222,187,65,228,220,295,66,118,158,92,104,242,279,188,169,54,122,278,74,282,213,90,176)
...
Based on a p-value of 0.2828, there is no evidence of a design effect on the true mean price. At the $\alpha$ =  cutoff, design did not have an effect on the true mean price.
...
{\bf CHECK VALUES INPUT CORRECTLY}
